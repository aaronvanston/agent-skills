...
## Table of Contents
- [Query Pattern with Index](#query-pattern-with-index)
- [Avoid .filter()](#avoid-filter-on-database-queries)
- [Bounded .collect()](#only-use-collect-with-small-result-sets)
- [Index Configuration](#index-configuration)
- [Redundant Indexes](#check-for-redundant-indexes)
- [Date.now() in Queries](#dont-use-datenow-in-queries)
- [Write Conflict Avoidance](#write-conflict-avoidance-occ)
