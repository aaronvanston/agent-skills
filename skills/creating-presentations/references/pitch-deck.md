...
Investor-ready decks that stand alone without a presenter. Denser than presented decks, following established VC frameworks.

## Pitch Deck vs. Presented Deck

| Aspect | Presented | Pitch Deck |
|--------|-----------|------------|
...
| Read speed | 3 sec/slide (glance) | 30-60 sec/slide (studied) |
